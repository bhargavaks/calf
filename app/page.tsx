  ...
  return (
    <div ref={ref} style={{
      ...
      <div style={{
        ...
        border: "1.5px solid rgba(90,140,100,0.35)",
        display: "flex", alignItems: "center", justifyContent: "center",
        fontFamily: "'Playfair Display', serif",
        fontSize: "0.95rem", color: "#4A8A5A",
        background: "rgba(90,140,100,0.07)",
      }}>{num}</div>
      <div>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
          ...
          --bg2:       #EDE8DC;
          --bg3:       #EAE4D6;
          --border:    rgba(90,110,85,0.12);
          --ink:       #2E3528;
          --muted:     rgba(46,53,40,0.5);
          --green:     #4A8A5A;
          --green-dim: rgba(74,138,90,0.1);
          --sage:      #7A9E7C;
          --terracotta:#B5654A;
          --warm:      #C8956A;
        }
        ...
        .cursor-ring {
          ...
          border: 1.5px solid rgba(74,138,90,0.4); border-radius: 50%;
        ...
        .nav-link {
          ...
          text-decoration: none; padding: 0.4rem 0.9rem; border-radius: 100px;
          transition: color 0.2s, background 0.2s;
        }
        .nav-link:hover { color: var(--ink); background: rgba(74,138,90,0.08); }
        .nav-cta {
          font-size: 0.84rem; font-weight: 600; color: #F5F0E8;
          text-decoration: none; padding: 0.55rem 1.4rem; border-radius: 100px;
          background: var(--ink); transition: background 0.2s, transform 0.2s;
        }
        ...
        .hero-tag {
          ...
          color: var(--green);
          border: 1.5px solid rgba(74,138,90,0.25);
          border-radius: 100px; padding: 0.35rem 1rem;
          margin-bottom: 2.5rem;
          background: rgba(74,138,90,0.07);
        ...
        .hero-headline {
          ...
          letter-spacing: -0.04em; max-width: 880px;
        ...
        .mood-display {
          margin-top: 1.2rem; font-size: 0.87rem; color: var(--muted);
        ...
        .btn-main {
          ...
          text-decoration: none; padding: 0.9rem 2.2rem; border-radius: 100px;
        ...
        .btn-ghost {
          ...
          text-decoration: none; padding: 0.9rem 2rem; border-radius: 100px;
        ...
        .scroll-line {
          ...
          background: linear-gradient(to bottom, rgba(74,138,90,0.5), transparent);
          animation: scrollPulse 2.5s ease-in-out infinite;
        }

        .divider {
          height: 1px;
          background: linear-gradient(to right, transparent, rgba(90,110,85,0.15), transparent);
          margin: 0 3rem;
        }
        ...
        .section-title {
          ...
          letter-spacing: -0.03em; max-width: 560px; margin-bottom: 1rem;
          color: var(--ink);
        }
        ...
        .about-inner {
          max-width: 1080px; margin: 0 auto; padding: 7rem 2.5rem;
          display: grid; grid-template-columns: 1fr 1.5fr; gap: 5rem; align-items: center;
        }
        .about-avatar {
          width: 100%; aspect-ratio: 1; max-width: 300px;
          border-radius: 32px;
          background: linear-gradient(135deg, rgba(122,158,124,0.2), rgba(200,149,106,0.12));
          border: 1.5px solid rgba(90,140,100,0.2);
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          gap: 1rem; font-size: 5rem; position: relative; overflow: hidden;
          box-shadow: 0 8px 40px rgba(74,138,90,0.08);
        }
        .about-avatar::before {
          content: '';
          position: absolute; inset: 0;
          background: radial-gradient(circle at 35% 35%, rgba(122,158,124,0.15), transparent 65%);
        }
        .about-name-badge {
        ...
        .about-tag {
          ...
          padding: 0.3rem 0.85rem; background: rgba(255,255,255,0.5);
        }
      ...
      <div className="quote-section">
        <FadeIn>
          <p className="quote-text">
            "Rest is not a <em>reward</em> for finishing everything.<br />
            it's what makes finishing anything possible."
          </p>
        ...
        <div className="about-inner">
          ...
          <FadeIn delay={0.12}>
            ...
            <p className="about-body">
              Hey, I'm <strong>Bhargava K S</strong> — an ECE student, and yeah, I've been cooked before.
            </p>
            <p className="about-body">
              I built Calf because when I was burnt out, everything I found online felt designed for someone who already had their life together. Generic tips. Toxic positivity. Nothing that actually acknowledged how <strong>specific and heavy</strong> student burnout feels.
            </p>
            <p className="about-body">
              Calf is my attempt to fix that — a no-BS tool that meets you where you are, helps you understand what's actually going on, and gives you a path forward that's doable alongside a full course load.
            </p>
